define(function (require, exports, module) {
     ...
     //编辑
     exports.helpapplyeditFunc=function(data){
		new mdboss.View.helpapplyedit(data);
     };
     
	
     mdboss.View.helpapplyedit = Backbone.View.extend({
         initialize:function(data){
        	 ...
        	 //模版页面
        	 this.view_html = require("text!template/page/help/apply/view.html");
        	 this.edit_html = require("text!template/page/help/apply/edit.html");
        	 this.batchedit_html=require("text!template/page/help/apply/batchedit.html");
             ...
             }, {"title":_this.title ,"width":"850px","height":_this.height,"icon":"iconfont icon-mdliucheng","resize":function(){
                 }}).show(function(){
                	 var dialog=this;
                	 if(_this.rdata.tid){//编辑
	                	 var reqData = new Array();
	                	 reqData.push( {"name" : "moduledetail", "post" : { "usercode":mdboss.usercode, "tid":_this.rdata.tid },cache:false });
	
	                     mdboss.getReady({ data: reqData , template: [] }, function (result, msg) {
	                         if (result) {
	                        	 var resData = result.data["moduledetail"];
//	                        	 console.log(resData);
                 		 		if(_this.rdata.detail){//详情
         ...
         selected_person:function(e){//人员选择
        	 _this=this;
