define(function (require, exports, module) {
     ...
     mdboss.View.workformitemedit = Backbone.View.extend({
         initialize:function(data){
        	 _this=this;
        	 _this.tid=data.tid;
        	 _this.rdata=data;
        	 _this.detail = data.view;
        	 this.modeuledetail_html = require("text!template/page/process/query/workformitem/view.html");
        	 this.modeuledit_html = require("text!template/page/process/query/workformitem/edit.html");
