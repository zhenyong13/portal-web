define(function (require, exports, module) {
     ...
     mdboss.View.workformedit = Backbone.View.extend({
         initialize:function(data){
        	 _this=this;
        	 _this.tid=data.tid;
        	 _this.rdata=data;
        	 _this.detail = data.view;
        	 this.modeuledetail_html = require("text!template/page/process/query/workform/view.html");
        	 this.modeuledit_html = require("text!template/page/process/query/workform/edit.html");
        	 ...
        	 _this.dialog=new Dialog({
                 ...
                 fillCallback:function(){
                	 ...
                	 if(_this.tid){//编辑
	                	 ...
	                	 reqData.push( {"name" : "workformdetail", "post" : { "usercode":mdboss.usercode, "tid":_this.tid },cache:false });
	
	                     mdboss.getReady({ data: reqData , template: [] }, function (result, msg) {
	                         if (result) {
	                        	 var resData = result.data["workformdetail"];
	                        	 console.log(resData);
                 		 		if(_this.detail){//详情
