...
define(function (require, exports, module) {
    ...
    mdboss.View.dashSetting = Backbone.View.extend({
        ...
        resetsetting:function(e){
        	...
        	saveSort.save({"usercode":mdboss.usercode,"appcode":"ucp"},{url:mdboss.api.dashMoudleReset,success:function(model,res){
        		if(res.rc==1){
        			mdboss.alert("更新成功");
        ...
        updateState:function(e){
    		...
    		var saveSort=new mdboss.Model.commonModel();
    		saveSort.save({"usercode":mdboss.usercode,"appcode":"ucp","data":[{"isshow":isshow,"sortorder":sortorder,"sid":sid,"tid":tid}]},{url:mdboss.api.dashMoudleUpdate,success:function(m,res){
    			if(res.rc==1){
    				console.log("更新成功");
    			}else{
    				console.log(res.msg);
        ...
        initialize: function () {
    		var thtml=require("text!../../../template/page/profile/dashboardsSet.html");
    		mdboss.fillPage(thtml);
    		var template=Handlebars.compile($("#moudle-template").html());
    		var commonModel =  new mdboss.Model.commonModel();
    		commonModel.save({"usercode":mdboss.usercode,"appcode":"ucp"},{url:mdboss.api.dashMoudleQuery,success:function(model,res){
    			if(res.rc==1){
