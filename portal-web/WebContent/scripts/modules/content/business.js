define(function (require, exports, module) {
     ...
     //新闻 
     exports.businessFunc=function(){
    	mdboss.fillPage(require("text!template/page/content/business/index.html"));
		new mdboss.View.newsView();
     };
     
     mdboss.View.newsView = Backbone.View.extend({
...
//        	 pview.$el.find("creator").attr("data-code", usercode);
         ...
         topshowNews:function(e){//置顶-
        	 ...
        	 mdboss.reqsubmit(reqData, mdboss.api.newsedit, function(m, res){
        		 if(res.rc==1){
        			 mdboss.alert(msg);
        			 t_this.renderData();
        		 }else{
