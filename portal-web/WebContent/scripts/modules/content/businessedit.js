define(function (require, exports, module) {
     ...
     //模块函数
     exports.businesseditFunc=function(data){
		new mdboss.View.businessedit(data);
     };
     
	
     mdboss.View.businessedit = Backbone.View.extend({
         initialize:function(data){
        	 ...
        	 //模版页面
        	 this.view_html = require("text!template/page/content/business/view.html");
        	 this.edit_html = require("text!template/page/content/business/edit.html");
        	 this.batchedit_html=require("text!template/page/content/business/batchedit.html");
         ...
         dataselect:function(topshow, newstype , status){//下拉列表数据获取
        	 ...
        	 mdboss.dataselect(this, "newstype", "OA_ISSUETYPE",newstype);
        	 mdboss.dataselect(this, "status", "OA_ISSUETYPE",status);
         },
         events: {
        	 'click #submit':'submit',//提交
        	 'click #cancel':'cancel',//取消
        	 "change .js_new_img_upload":"jsNewImgUpload",//业务指引图片上传
         ...
         jsNewImgUpload:function(e){//业务指引图片上传
        	 _this=this;
