...
var lameIE = !$.support.leadingWhitespace;
...
$.fn.media.defaults.players = {
	...
	winmedia: {
		...
		mimetype:	  /firefox/.test(navigator.userAgent.toLowerCase()) && isFirefoxWMPPluginInstalled() ? 'application/x-ms-wmp' : 'application/x-mplayer2',
...
function generate(el, opts, player) {
	...
	if (player == 'iframe') {
		...
		// Alternate HTML
		a.push('<div><p><strong>需要安装插件或缺少播放器</strong></p><p>请安装'+o.title+'插件</p><p><a href="'+o.pluginspage+'">点击下载</a></p></div>');
		a.push('</ob'+'ject'+'>');
	}
	 else {
