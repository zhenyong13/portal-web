...
//                    this.rightCalendar.month = this.startDate.clone().date(2).add(1, 'month');
                ...
                if (this.leftCalendar.month.format('YYYY-MM') != this.startDate.format('YYYY-MM') && this.rightCalendar.month.format('YYYY-MM') != this.startDate.format('YYYY-MM')) {
                    this.leftCalendar.month = this.startDate.clone().date(2);
//                    this.rightCalendar.month = this.startDate.clone().date(2).add(1, 'month'); TODO
...
//            console.log(month);
        ...
        move: function() {
            ...
            //判断显示位置高度
            var windowheight=0;
            if($(this.element).closest(".sp-dialog").length>0){
            	windowheight=$(this.element).closest(".sp-dialog").outerHeight();
            }else{
            	windowheight=$(window).outerHeight();
            }
            var showheight=windowheight-this.element.offset().top;
            var calanderheight=this.container.outerHeight();
            if(showheight<=calanderheight){
            	if(showheight<this.element.offset().top){
            		this.drops ='up';
            	}else{
            		this.drops = 'down';
            	}
...
//            console.log("click date ..");
            ...
            if(cal.hasClass('left')){//左侧点击
            	if (date.isBefore(this.endDate)) {//小于开始和结束时间
                  if (this.timePicker) {
...
//                  this.endDate = null;
            	...
            	if (date.isBefore(this.startDate)) {//小于开始 
                    if (this.timePicker) {
...
//            }
        ...
        clickCancel: function(e) {//TODO 取消
